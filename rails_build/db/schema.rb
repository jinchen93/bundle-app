...
ActiveRecord::Schema.define(version: 20170430011444) do
  ...
  create_table "twitch_channels", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["user_id"], name: "index_twitch_channels_on_user_id", using: :btree
    t.index ["username"], name: "index_twitch_channels_on_username", using: :btree
  end
